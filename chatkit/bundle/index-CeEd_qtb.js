...
class M {
  constructor(e, t) {
    ...
    return (
      (b.name = "ParseError"),
      (b.__proto__ = M.prototype),
      (b.position = n),
      n != null && s != null && (b.length = s - n),
      (b.rawMessage = e),
      b
    );
  }
...
var Oa = function (e, t) {
  ...
  Va = /[&><"']/g;
function Ga(r) {
  return String(r).replace(Va, (e) => Pa[e]);
}
var Tr = function r(e) {
  ...
  constructor(e) {
    ...
    for (var t in Ae)
      if (Ae.hasOwnProperty(t)) {
        var a = Ae[t];
        this[t] =
          e[t] !== void 0 ? (a.processor ? a.processor(e[t]) : e[t]) : Xa(a);
      }
  }
...
class F0 {
  ...
  sup() {
    return y0[Wa[this.id]];
  }
  sub() {
    return y0[ja[this.id]];
  }
  fracNum() {
    return y0[Za[this.id]];
  }
  fracDen() {
    return y0[Ka[this.id]];
  }
  cramp() {
    return y0[Ja[this.id]];
  }
...
var gt = 0,
  ...
  Wa = [oe, d0, oe, d0, re, n0, re, n0],
  ja = [d0, d0, d0, d0, n0, n0, n0, n0],
  Za = [te, B0, oe, d0, re, n0, re, n0],
  Ka = [B0, B0, d0, d0, n0, n0, n0, n0],
  Ja = [Be, Be, B0, B0, d0, d0, n0, n0],
  Qa = [gt, Be, te, B0, te, B0, te, B0],
  I = { DISPLAY: y0[gt], TEXT: y0[te], SCRIPT: y0[oe], SCRIPTSCRIPT: y0[re] },
  st = [
    {
      name: "latin",
      blocks: [
...
function bt(r, e, t) {
  ...
  var a = r.charCodeAt(0),
    n = x0[e][a];
  if (
    (!n && r[0] in Vt && ((a = Vt[r[0]].charCodeAt(0)), (n = x0[e][a])),
    !n && t === "text" && Br(a) && (n = x0[e][77]),
    n)
  )
...
function m1(r) {
  var e;
  if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !Ye[e])) {
    var t = (Ye[e] = { cssEmPerMu: ge.quad[e] / 18 });
...
class T0 {
  ...
  havingStyle(e) {
    return this.style === e
      ? this
      : this.extend({ style: e, size: Ut(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  baseSizingClasses() {
    return this.size !== T0.BASESIZE
      ? ["sizing", "reset-size" + this.size, "size" + T0.BASESIZE]
      : [];
  }
  fontMetrics() {
    return (
      this._fontMetrics || (this._fontMetrics = m1(this.size)),
      this._fontMetrics
    );
  }
  getColor() {
  ...
  qr = function (e) {
    ...
    for (var n in this.style)
      this.style.hasOwnProperty(n) &&
        (a += q.hyphenate(n) + ":" + this.style[n] + ";");
    a && (t += ' style="' + q.escape(a) + '"');
    for (var s in this.attributes)
      if (this.attributes.hasOwnProperty(s)) {
        if (f1.test(s)) throw new M("Invalid attribute name '" + s + "'");
...
class p1 {
  ...
  toMarkup() {
    var e =
        ...
        q.escape(this.src) +
        '"' +
        (' alt="' + q.escape(this.alt) + '"'),
      t = "";
    for (var a in this.style)
      this.style.hasOwnProperty(a) &&
        (t += q.hyphenate(a) + ":" + this.style[a] + ";");
    return (t && (e += ' style="' + q.escape(t) + '"'), (e += "'/>"), e);
  }
}
var v1 = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
class p0 {
  constructor(e, t, a, n, s, o, h, m) {
    ((this.text = void 0),
      ...
      (this.style = m || {}),
      (this.maxFontSize = 0));
    var p = _a(this.text.charCodeAt(0));
    (p && this.classes.push(p + "_fallback"),
      /[îïíì]/.test(this.text) && (this.text = v1[this.text]));
  }
  hasClass(e) {
    return q.contains(this.classes, e);
  }
  ...
  toNode() {
    ...
    return (
      this.alternate
        ...
        : t.setAttribute("d", Pt[this.pathName]),
      t
    );
  }
  toMarkup() {
    return this.alternate
      ...
      : '<path d="' + q.escape(Pt[this.pathName]) + '"/>';
  }
}
class ot {
  constructor(e) {
...
var b1 = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  y1 = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  X = { math: {}, text: {} };
function i(r, e, t, a, n, s) {
  ((X[r][n] = { font: e, group: t, replace: a }),
    s && a && (X[r][a] = X[r][n]));
}
var l = "math",
  k = "text",
...
i(l, d, N, "⊡", "\\boxdot", !0);
i(l, u, N, "△", "\\bigtriangleup");
i(l, u, N, "▽", "\\bigtriangledown");
i(l, u, N, "†", "\\dagger");
i(l, u, N, "⋄", "\\diamond");
i(l, u, N, "⋆", "\\star");
i(l, u, N, "◃", "\\triangleleft");
...
i(k, u, E, "h", "ℎ");
var O = "";
for (var a0 = 0; a0 < Ne.length; a0++) {
  var J = Ne.charAt(a0);
  ((O = String.fromCharCode(55349, 56320 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56372 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56424 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56580 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56684 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56736 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56788 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56840 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    (O = String.fromCharCode(55349, 56944 + a0)),
    i(l, u, E, J, O),
    i(k, u, v, J, O),
    a0 < 26 &&
      ((O = String.fromCharCode(55349, 56632 + a0)),
      i(l, u, E, J, O),
      i(k, u, v, J, O),
      (O = String.fromCharCode(55349, 56476 + a0)),
      i(l, u, E, J, O),
      i(k, u, v, J, O)));
}
O = "𝕜";
...
for (var $0 = 0; $0 < 10; $0++) {
  var L0 = $0.toString();
  ((O = String.fromCharCode(55349, 57294 + $0)),
    i(l, u, E, L0, O),
    i(k, u, v, L0, O),
    (O = String.fromCharCode(55349, 57314 + $0)),
    i(l, u, E, L0, O),
    i(k, u, v, L0, O),
    (O = String.fromCharCode(55349, 57324 + $0)),
    i(l, u, E, L0, O),
    i(k, u, v, L0, O),
    (O = String.fromCharCode(55349, 57334 + $0)),
    i(l, u, E, L0, O),
    i(k, u, v, L0, O));
}
var ut = "ÐÞþ";
...
var xe = [
  ...
  b0 = function (e, t, a, n, s) {
    ...
    if (h) {
      ...
      ((a === "text" || (n && n.font === "mathit")) && (p = 0),
        (m = new p0(e, h.height, h.depth, p, h.skew, h.width, s)));
    } else
      (typeof console < "u" &&
        console.warn(
        ...
        (m = new p0(e, 0, 0, 0, 0, 0, s)));
    if (n) {
      ((m.maxFontSize = n.sizeMultiplier),
        n.style.isTight() && m.classes.push("mtight"));
      var g = n.getColor();
      g && (m.style.color = g);
    }
    return m;
  ...
  w1 = function (e, t, a, n) {
    return (
      n === void 0 && (n = []),
      a.font === "boldsymbol" && Ie(e, "Main-Bold", t).metrics
  ...
  S1 = function (e, t, a) {
    var n = e.mode,
      ...
      p = "",
      g = "";
    if ((s.charCodeAt(0) === 55349 && ([p, g] = x1(s, n)), p.length > 0))
      return b0(s, p, n, t, o.concat(g));
    if (m) {
      var b, w;
      if (m === "boldsymbol") {
        var x = k1(s, n, t, o, a);
        ((b = x.fontName), (w = [x.fontClass]));
      } else
        h
          ? ((b = Or[m].fontName), (w = [m]))
          : ((b = we(m, t.fontWeight, t.fontShape)),
            (w = [m, t.fontWeight, t.fontShape]));
      if (Ie(s, b, n).metrics) return b0(s, b, n, t, o.concat(w));
      if (Er.hasOwnProperty(s) && b.slice(0, 10) === "Typewriter") {
        for (var z = [], T = 0; T < s.length; T++)
          z.push(b0(s[T], b, n, t, o.concat(w)));
        return Rr(z);
      }
    }
    if (a === "mathord")
    ...
    if (a === "textord") {
      var D = X[n][s] && X[n][s].font;
      if (D === "ams") {
        var C = we("amsrm", t.fontWeight, t.fontShape);
        return b0(s, C, n, t, o.concat("amsrm", t.fontWeight, t.fontShape));
      } else if (D === "main" || !D) {
        var R = we("textrm", t.fontWeight, t.fontShape);
        return b0(s, R, n, t, o.concat(t.fontWeight, t.fontShape));
      } else {
        var F = we(D, t.fontWeight, t.fontShape);
  ...
  N1 = function (e) {
    if (e.positionType === "individualShift") {
      for (
        ...
        ((s = s + h), a.push({ type: "kern", size: m }), a.push(t[o]));
      }
  ...
  D1 = function (e, t) {
    for (
      var { children: a, depth: n } = N1(e), s = 0, o = 0;
      o < a.length;
      o++
    ) {
      var h = a[o];
    ...
    if (b < 0) {
      ...
      H = [l0(["vlist-r"], [G, j]), l0(["vlist-r"], [V])];
    } else H = [l0(["vlist-r"], [G])];
    var Y = l0(["vlist-t"], H);
    return (
      H.length === 2 && Y.classes.push("vlist-t2"),
      (Y.height = w),
      (Y.depth = -b),
      Y
    );
  ...
  q1 = function (e, t) {
    var [a, n, s] = Fr[e],
      ...
      m = Ir(["overlay"], [h], t);
    return ((m.height = s), (m.style.height = A(s)), (m.style.width = A(n)), m);
  },
  y = {
    fontMap: Or,
    makeSymbol: b0,
  ...
  A0 = { number: 5, unit: "mu" },
  E1 = {
    mord: { mop: Z, mbin: X0, mrel: A0, minner: Z },
    mop: { mord: Z, mop: Z, mrel: A0, minner: Z },
    mbin: { mord: X0, mop: X0, mopen: X0, minner: X0 },
    mrel: { mord: A0, mop: A0, mopen: A0, minner: A0 },
    mopen: {},
    mclose: { mop: Z, mbin: X0, mrel: A0, minner: Z },
    mpunct: {
      mord: Z,
      mop: Z,
      mrel: A0,
...
var qe = function (e) {
  ...
  C0 = y.makeSpan,
  R1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
  O1 = ["rightmost", "mrel", "mclose", "mpunct"],
  F1 = {
    display: I.DISPLAY,
    text: I.TEXT,
    script: I.SCRIPT,
  ...
  t0 = function (e, t, a, n) {
    ...
    if (e.length === 1) {
      ...
      g.type === "sizing"
        ...
        : g.type === "styling" && (p = t.havingStyle(F1[g.style]));
    }
    var b = C0([n[0] || "leftmost"], [], t),
    ...
    return (
      Kt(
        ...
        (z, T) => {
          var D = T.classes[0],
            C = z.classes[0];
          D === "mbin" && q.contains(O1, C)
            ? (T.classes[0] = "mord")
            : C === "mbin" && q.contains(R1, D) && (z.classes[0] = "mord");
        },
        { node: b },
        w,
        x,
      ...
      Kt(
        ...
        (z, T) => {
          var D = ht(T),
            C = ht(z),
            R = D && C ? (z.hasClass("mtight") ? I1[D][C] : E1[D][C]) : null;
          if (R) return y.makeGlue(R, p);
        },
        { node: b },
        w,
        x,
  ...
  Kt = function r(e, t, a, n, s) {
    ...
    for (var o = 0; o < e.length; o++) {
      ...
      (p
        ? (a.node = h)
        : s && h.hasClass("newline") && (a.node = C0(["leftmost"])),
        (a.insertAfter = ((b) => (w) => {
          (e.splice(b + 1, 0, w), o++);
        })(o)));
    }
  ...
  ht = function (e, t) {
    return e ? (t && (e = H1(e, t)), L1[e.classes[0]] || null) : null;
  },
  ue = function (e, t) {
...
function mt(r, e) {
  ...
  if ((g.setAttribute("aria-hidden", "true"), p)) {
    var b = p.children[0];
    ((b.style.height = A(g.height + g.depth)),
      g.depth && (b.style.verticalAlign = A(-g.depth)));
  }
  return g;
}
function Pr(r) {
...
class h0 {
  ...
  toNode() {
    ...
    for (var a = 0; a < this.children.length; a++)
      if (
        this.children[a] instanceof w0 &&
        this.children[a + 1] instanceof w0
      ) {
        for (
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        ...
        (e += '"'));
    (this.classes.length > 0 &&
      (e += ' class ="' + q.escape(P0(this.classes)) + '"'),
      (e += ">"));
    for (var a = 0; a < this.children.length; a++)
      e += this.children[a].toMarkup();
...
var S = { MathNode: h0, TextNode: w0, SpaceNode: P1, newDocumentFragment: Pr },
  v0 = function (e, t, a) {
    return (
      X[t][e] &&
        X[t][e].replace &&
  ...
  kt = function (e, t) {
    ...
    return bt(s, o, n) ? y.fontMap[a].variant : null;
  };
function Ze(r) {
  if (!r) return !1;
    ...
    for (var s = [], o, h = 0; h < e.length; h++) {
      ...
      if (m instanceof h0 && o instanceof h0) {
        if (
          ...
          o.children.push(...m.children);
          continue;
        } else if (Ze(m) && o.type === "mn") {
          o.children.push(...m.children);
          continue;
        } else if (m.type === "mn" && Ze(o))
          ((m.children = [...o.children, ...m.children]), s.pop());
        else if (
          (m.type === "msup" || m.type === "msub") &&
          m.children.length >= 1 &&
          (o.type === "mn" || Ze(o))
        ) {
          var p = m.children[0];
          p instanceof h0 &&
            p.type === "mn" &&
            ((p.children = [...o.children, ...p.children]), s.pop());
          ...
          if (
            ...
            b instanceof w0 &&
              b.text.length > 0 &&
              ((b.text = b.text.slice(0, 1) + "̸" + b.text.slice(1)), s.pop());
          }
        }
      }
      (s.push(m), (o = m));
...
function Jt(r, e, t, a, n) {
  ...
  s.length === 1 &&
  s[0] instanceof h0 &&
  q.contains(["mrow", "mtable"], s[0].type)
    ? (o = s[0])
...
var Vr = function (e) {
  ...
  V1 = function (e, t, a) {
    var n = Vr(a),
      s;
    if (a.output === "mathml") return Jt(e, t, n, a.displayMode, !0);
    if (a.output === "html") {
      var o = mt(e, n);
      s = y.makeSpan(["katex"], [o]);
    } else {
      var h = Jt(e, t, n, a.displayMode, !1),
        m = mt(e, n);
  ...
  Y1 = function (e) {
    var t = new S.MathNode("mo", [new S.TextNode(U1[e.replace(/^\\/, "")])]);
      ...
      if (q.contains(["widehat", "widecheck", "widetilde", "utilde"], m)) {
        ...
        if (g > 5)
          m === "widehat" || m === "widecheck"
            ? ((b = 420), (h = 2364), (x = 0.42), (w = m + "4"))
            : ((b = 312), (h = 2340), (x = 0.34), (w = "tilde4"));
        else {
          var z = [1, 1, 2, 2, 3, 3][g];
          m === "widehat" || m === "widecheck"
            ? ((h = [0, 1062, 2364, 2364, 2364][z]),
              (b = [0, 239, 300, 360, 420][z]),
              (x = [0, 0.24, 0.3, 0.3, 0.36, 0.42][z]),
              (w = m + z))
            : ((h = [0, 600, 1033, 2339, 2340][z]),
              (b = [0, 260, 286, 306, 312][z]),
        ...
        return { span: y.makeSvgSpan([], [D], t), minWidth: 0, height: x };
      } else {
        var C = [],
          R = $1[m],
          [F, G, H] = R,
        ...
        for (var r0 = 0; r0 < V; r0++) {
          var e0 = new V0(F[r0]),
            ...
            s0 = y.makeSvgSpan([j[r0]], [Y0], t);
          if (V === 1) return { span: s0, minWidth: G, height: U };
          ((s0.style.height = A(U)), C.push(s0));
        }
        return { span: y.makeSpan(["stretchy"], C, t), minWidth: G, height: U };
      }
    }
  ...
  q0 = { encloseSpan: j1, mathMLnode: Y1, svgSpan: W1 };
function L(r, e) {
  if (!r || r.type !== e)
    throw new Error(
...
function Re(r) {
  return r && (r.type === "atom" || y1.hasOwnProperty(r.type)) ? r : null;
}
var Mt = (r, e) => {
    var t, a, n;
    r && r.type === "supsub"
    ...
    var s = P(t, e.havingCrampedStyle()),
      ...
      h = 0;
    if (o) {
      var m = q.getBaseElem(t),
        p = P(m, e.havingCrampedStyle());
      h = Yt(p).skew;
    }
    var g = a.label === "\\c",
      b = g ? s.height + s.depth : Math.min(s.height, e.fontMetrics().xHeight),
      w;
    if (a.isStretchy)
      ((w = q0.svgSpan(a, e)),
        (w = y.makeVList(
      ...
      var x, z;
      (a.label === "\\vec"
        ? ((x = y.staticSvg("vec", e)), (z = y.svgData.vec[1]))
        : ((x = y.makeOrd({ mode: a.mode, text: a.label }, e, "textord")),
          (x = Yt(x)),
          (x.italic = 0),
          (z = x.width),
          g && (b += x.depth)),
        (w = y.makeSpan(["accent-body"], [x])));
      var T = a.label === "\\textcircled";
      T && (w.classes.push("accent-full"), (b = s.height));
      var D = h;
      (T || (D -= z / 2),
        (w.style.left = A(D)),
    ...
    var C = y.makeSpan(["mord", "accent"], [w], e);
    return n
      ? ((n.children[0] = C),
        (n.height = Math.max(C.height, n.height)),
        (n.classes[0] = "mord"),
        n)
      : C;
  },
  Ur = (r, e) => {
    var t = r.isStretchy
        ? q0.mathMLnode(r.label)
        : new S.MathNode("mo", [v0(r.label, r.mode)]),
      a = new S.MathNode("mover", [$(r.base, e), t]);
...
B({
  ...
  mathmlBuilder: (r, e) => {
    var t = q0.mathMLnode(r.label),
      a = new S.MathNode("munder", [$(r.base, e), t]);
...
var J1 = {
  ...
  Qt = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
  _t = (r) => r.type === "textord" && r.text === "@",
...
function en(r) {
  ...
  for (var a = [], n = [a], s = 0; s < e.length; s++) {
    for (var o = e[s], h = Qt(), m = 0; m < o.length; m++)
      if (!_t(o[m])) h.body.push(o[m]);
      else {
        (a.push(h), (m += 1));
        var p = St(o[m]).text,
          g = new Array(2);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = e.havingStyle(e.style.sup()),
      a = y.wrapFragment(P(r.label, t, e), e);
    return (
  ...
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mrow", [$(r.label, e)]);
    return (
...
B({
  ...
  mathmlBuilder(r, e) {
    return new S.MathNode("mrow", [$(r.fragment, e)]);
  },
});
B({
  type: "textord",
  ...
  handler(r, e) {
    ...
    return (
      m <= 65535
        ...
        : ((m -= 65536),
          (p = String.fromCharCode((m >> 10) + 55296, (m & 1023) + 56320))),
...
B({
  ...
  handler(r) {
    ...
    if (ct[a.text])
      return (
        (t === "\\global" || t === "\\\\globallong") && (a.text = ct[a.text]),
...
B({
  ...
  handler(r) {
    ...
    return (
      ...
      e.gullet.macros.set(
        n,
        { tokens: m, numArgs: s, delimiters: h },
        t === ct[t],
      ),
...
var se = function (e, t, a) {
  ...
  zt = function (e, t, a, n) {
    var s = a.havingBaseStyle(t),
      o = y.makeSpan(n.concat(s.sizingClasses(a)), [e], a),
  ...
  rn = function (e, t, a, n, s, o) {
    var h = y.makeSymbol(e, "Main-Regular", s, n),
      m = zt(h, t, n, o);
    return (a && Kr(m, n, t), m);
  },
  an = function (e, t, a, n) {
  ...
  Jr = function (e, t, a, n, s, o) {
    var h = an(e, t, s, n),
      m = zt(y.makeSpan(["delimsizing", "size" + t], [h], n), I.TEXT, n, o);
    return (a && Kr(m, n, I.TEXT), m);
  },
  Ke = function (e, t, a) {
    var n;
  ...
  Je = function (e, t, a) {
    var n = x0["Size4-Regular"][e.charCodeAt(0)]
      ...
      s = new V0("inner", o1(e, Math.round(1e3 * t))),
      o = new D0([s], {
        width: A(n),
        height: A(t),
        style: "width:" + A(n),
  ...
  Qr = function (e, t, a, n, s, o) {
    ...
    var V = T + F + G,
      j = Math.max(0, Math.ceil((t - V) / (H * C))),
      Y = V + j * H * C,
    ...
    if (b.length > 0) {
      var Y0 = Y - T - F,
        ...
        R0 = y.makeSvgSpan([], [Pe], n);
      ((R0.height = s0 / 1e3),
        (R0.style.width = Z0),
        (R0.style.height = K0),
        e0.push({ type: "elem", elem: R0 }));
    } else {
      if ((e0.push(Ke(g, x, s)), e0.push(Me), m === null)) {
        var O0 = Y - T - F + 2 * dt;
        e0.push(Je(p, O0, n));
      } else {
        var c0 = (Y - T - F - G) / 2 + 2 * dt;
        (e0.push(Je(p, c0, n)),
          e0.push(Me),
          e0.push(Ke(m, x, s)),
          e0.push(Me),
    ...
    var ie = n.havingBaseStyle(I.TEXT),
      Ve = y.makeVList(
        { positionType: "bottom", positionData: r0, children: e0 },
        ie,
      );
    return zt(y.makeSpan(["delimsizing", "mult"], [Ve], ie), I.TEXT, n, o);
  },
  Qe = 80,
  _e = 0.08,
  et = function (e, t, a, n, s) {
    var o = l1(e, n, a),
      h = new V0(e, o),
      m = new D0([h], {
        width: "400em",
  ...
  ln = function (e, t) {
    var a = t.havingBaseSizing(),
      n = ra("\\surd", e * a.sizeMultiplier, ta, a),
      s = a.sizeMultiplier,
      ...
      n.type === "small"
        ...
        : n.type === "large"
          ? ((g = (1e3 + Qe) * le[n.size]),
            (p = (le[n.size] + o) / s),
            (m = (le[n.size] + o + _e) / s),
            (h = et("sqrtSize" + n.size, m, g, o, t)),
            (h.style.minWidth = "1.02em"),
            (b = 1 / s))
          : ((m = e + o + _e),
            (p = e + o),
            (g = Math.floor(1e3 * e + o) + Qe),
            (h = et("sqrtTall", m, g, o, t)),
  ...
  le = [0, 1.2, 1.8, 2.4, 3],
  un = function (e, t, a, n, s) {
    if (
      (e === "<" || e === "\\lt" || e === "⟨"
        ? (e = "\\langle")
        : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"),
      q.contains(_r, e) || q.contains(ea, e))
    )
      return Jr(e, t, !1, a, n, s);
    if (q.contains(on, e)) return Qr(e, le[t], !1, a, n, s);
  ...
  aa = function (e, t, a, n, s, o) {
    e === "<" || e === "\\lt" || e === "⟨"
      ...
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var h;
    q.contains(ea, e) ? (h = hn) : q.contains(_r, e) ? (h = ta) : (h = mn);
    var m = ra(e, t, h, n);
    return m.type === "small"
      ? rn(e, m.style, a, n, s, o)
      : m.type === "large"
        ? Jr(e, m.size, a, n, s, o)
        : Qr(e, t, a, n, s, o);
  },
  dn = function (e, t, a, n, s, o) {
    var h = n.fontMetrics().axisHeight * n.sizeMultiplier,
      m = 901,
      p = 5 / n.fontMetrics().ptPerEm,
      g = Math.max(t - h, a + h),
      b = Math.max((g / 500) * m, 2 * g - p);
    return aa(e, b, !0, n, s, o);
  },
  N0 = {
    sqrtImage: ln,
    sizedDelim: un,
...
function Fe(r, e) {
  var t = Re(r);
  if (t && q.contains(fn, t.text)) return t;
  throw t
...
B({
  ...
  htmlBuilder: (r, e) =>
    r.delim === "."
      ? y.makeSpan([r.mclass])
      : N0.sizedDelim(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: (r) => {
    var e = [];
    ...
    var a = A(N0.sizeToMaxHeight[r.size]);
...
B({
  ...
  htmlBuilder: (r, e) => {
    ...
    if (
      (r.left === "."
        ? (h = ue(e, ["mopen"]))
        : (h = N0.leftRightDelim(r.left, a, n, e, r.mode, ["mopen"])),
      t.unshift(h),
      s)
    )
      for (var m = 1; m < t.length; m++) {
        var p = t[m],
          g = p.isMiddle;
        g && (t[m] = N0.leftRightDelim(g.delim, a, n, g.options, r.mode, []));
      }
    var b;
    if (r.right === ".") b = ue(e, ["mclose"]);
    else {
      var w = r.rightColor ? e.withColor(r.rightColor) : e;
      b = N0.leftRightDelim(r.right, a, n, w, r.mode, ["mclose"]);
    }
...
var At = (r, e) => {
    var t = y.wrapFragment(P(r.body, e), e),
      a = r.label.slice(1),
      n = e.sizeMultiplier,
      s,
      o = 0,
      ...
      (/box/.test(a)
        ...
        : a === "angl"
          ? ((C = Math.max(
            ...
            (T = 4 * C),
            (D = Math.max(0, 0.25 - t.depth)))
          : ((T = h ? 0.2 : 0), (D = T)),
        (s = q0.encloseSpan(t, a, T, D, e)),
        /fbox|boxed|fcolorbox/.test(a)
          ? ((s.style.borderStyle = "solid"), (s.style.borderWidth = A(C)))
          : a === "angl" &&
            C !== 0.049 &&
            ((s.style.borderTopWidth = A(C)),
            (s.style.borderRightWidth = A(C))),
        (o = t.depth + D),
        r.backgroundColor &&
    ...
    return (
      ...
      /cancel/.test(a) && !h
        ? y.makeSpan(["mord", "cancel-lap"], [R], e)
        : y.makeSpan(["mord"], [R], e)
    );
  },
  Tt = (r, e) => {
  ...
  function G() {
    R &&
      (r.gullet.macros.get("\\df@tag")
        ? (R.push(r.subparse([new f0("\\df@tag")])),
          r.gullet.macros.set("\\df@tag", void 0, !0))
        : R.push(!!m && r.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (F(), C.push(rr(r)); ; ) {
    var H = r.parseExpression(!1, p ? "\\end" : "\\\\");
    (r.gullet.endGroup(),
      r.gullet.beginGroup(),
      (H = { type: "ordgroup", mode: r.mode, body: H }),
      t && (H = { type: "styling", mode: r.mode, style: t, body: [H] }),
      z.push(H));
    var U = r.fetch().text;
    if (U === "&") {
      if (b && z.length === b) {
      ...
      r.consume();
      var V = void 0;
      (r.gullet.future().text !== " " && (V = r.parseSizeGroup(!0)),
        D.push(V ? V.value : null),
        G(),
        C.push(rr(r)),
        (z = []),
        T.push(z),
...
var S0 = function (e, t) {
    ...
    var z =
        e.colSeparationType === "CD" ? K({ number: 3, unit: "ex" }, t) : 12 * b,
      T = 3 * b,
      D = e.arraystretch * z,
      C = 0.7 * D,
      R = 0.3 * D,
    ...
    function G(pe) {
      for (var ve = 0; ve < pe.length; ++ve)
        (ve > 0 && (F += 0.25), p.push({ pos: F, isDashed: pe[ve] }));
    }
    for (G(o[0]), a = 0; a < e.body.length; ++a) {
      ...
      var z0 = e.rowGaps[a],
        r0 = 0;
      (z0 &&
        ((r0 = K(z0, t)), r0 > 0 && ((r0 += R), V < r0 && (V = r0), (r0 = 0))),
        e.addJot && (V += T),
        (j.height = U),
        (j.depth = V),
        (F += U),
    ...
    if (e.tags && e.tags.some((pe) => pe))
      for (a = 0; a < s; ++a) {
        var K0 = m[a],
          ...
          O0 = void 0;
        (R0 === !0
          ? (O0 = y.makeSpan(["eqn-num"], [], t))
          : R0 === !1
            ? (O0 = y.makeSpan([], [], t))
            : (O0 = y.makeSpan([], t0(R0, t, !0), t)),
          (O0.depth = K0.depth),
          (O0.height = K0.height),
          Z0.push({ type: "elem", elem: O0, shift: Pe }));
      }
    for (n = 0, I0 = 0; n < h || I0 < Y0.length; ++n, ++I0) {
      for (var c0 = Y0[I0] || {}, ie = !0; c0.type === "separator"; ) {
        if (
          (ie ||
            ((g0 = y.makeSpan(["arraycolsep"], [])),
            (g0.style.width = A(t.fontMetrics().doubleRuleSep)),
            s0.push(g0)),
          c0.separator === "|" || c0.separator === ":")
        ) {
          var Ve = c0.separator === "|" ? "solid" : "dashed",
            J0 = y.makeSpan(["vertical-separator"], [], t);
          ((J0.style.height = A(F)),
            (J0.style.borderRightWidth = A(g)),
            (J0.style.borderRightStyle = Ve),
            (J0.style.margin = "0 " + A(-g / 2)));
          var Ft = F - e0;
          (Ft && (J0.style.verticalAlign = A(-Ft)), s0.push(J0));
      ...
      if (!(n >= h)) {
        ...
        for (a = 0; a < s; ++a) {
          ...
          if (fe) {
            ...
            ((fe.depth = de.depth),
              (fe.height = de.height),
              _0.push({ type: "elem", elem: fe, shift: Ba }));
          }
        }
        ((_0 = y.makeVList(
          ...
          (_0 = y.makeSpan(["col-align-" + (c0.align || "c")], [_0])),
          s0.push(_0),
          (n < h - 1 || e.hskipBeforeAndAfter) &&
            ((Q0 = q.deflt(c0.postgap, w)),
            Q0 !== 0 &&
              ((g0 = y.makeSpan(["arraycolsep"], [])),
              (g0.style.width = A(Q0)),
              s0.push(g0))));
    ...
    if (((m = y.makeSpan(["mtable"], s0)), p.length > 0)) {
      for (
        var Na = y.makeLineSpan("hline", t, g),
          Da = y.makeLineSpan("hdashline", t, g),
          Ge = [{ type: "elem", elem: m, shift: 0 }];
        p.length > 0;
      ) {
        var Lt = p.pop(),
          Ht = Lt.pos - e0;
        Lt.isDashed
          ? Ge.push({ type: "elem", elem: Da, shift: Ht })
          : Ge.push({ type: "elem", elem: Na, shift: Ht });
      }
      m = y.makeVList({ positionType: "individualShift", children: Ge }, t);
    }
    if (Z0.length === 0) return y.makeSpan(["mord"], [m], t);
    var Ue = y.makeVList({ positionType: "individualShift", children: Z0 }, t);
    return ((Ue = y.makeSpan(["tag"], [Ue], t)), y.makeFragment([m, Ue]));
  },
  pn = { c: "center ", l: "left ", r: "right " },
  M0 = function (e, t) {
    for (
      var a = [],
      ...
      (e.tags &&
        e.tags[o] &&
        (m.unshift(n), m.push(n), e.leqno ? m.unshift(s) : m.push(s)),
        a.push(new S.MathNode("mtr", m)));
    }
    ...
    if (e.cols && e.cols.length > 0) {
      var z = e.cols,
        ...
        C = 0,
        R = z.length;
      (z[0].type === "separator" && ((w += "top "), (C = 1)),
        z[z.length - 1].type === "separator" && ((w += "bottom "), (R -= 1)));
      for (var F = C; F < R; F++)
        z[F].type === "align"
          ? ((x += pn[z[F].align]), D && (T += "none "), (D = !0))
          : z[F].type === "separator" &&
            D &&
            ((T += z[F].separator === "|" ? "solid " : "dashed "), (D = !1));
    ...
    for (var Y = 1; Y < j.length - 1; Y++)
      V += j[Y].length === 0 ? "none " : j[Y][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test(V) && g.setAttribute("rowlines", V.trim()),
      w !== "" &&
  ...
  sa = function (e, t) {
    ...
    o.body.forEach(function (C) {
      for (var R = 1; R < C.length; R += 2) {
        var F = L(C[R], "styling"),
          G = L(F.body[0], "ordgroup");
        G.body.unshift(p);
      }
      if (x) m < C.length && (m = C.length);
      else {
        var H = C.length / 2;
        if (h < H)
          throw new M(
            "Too many math in a row: " + ("expected " + h + ", but got " + H),
            C[0],
          );
      }
    });
    for (var z = 0; z < m; ++z) {
      var T = "r",
        D = 0;
      (z % 2 === 1 ? (T = "l") : z > 0 && x && (D = 1),
        (a[z] = { type: "align", align: T, pregap: D, postgap: 0 }));
    }
...
k0({
  ...
  handler(r, e) {
    ...
    return U0(r.parser, s, Nt(r.envName));
  },
  htmlBuilder: S0,
  mathmlBuilder: M0,
});
k0({
  ...
  handler(r) {
    ...
    var s = U0(r.parser, a, Nt(r.envName)),
...
B({
  ...
  handler(r, e) {
    ...
    if (a === "\\begin") {
      if (!ar.hasOwnProperty(s)) throw new M("No such environment: " + s, n);
      var h = ar[s],
...
var ua = (r, e) => {
    ...
    return (
      r === "display"
        ? (t = t.id >= I.SCRIPT.id ? t.text() : I.DISPLAY)
        : r === "text" && t.size === I.DISPLAY.size
          ? (t = I.TEXT)
          : r === "script"
            ? (t = I.SCRIPT)
            : r === "scriptscript" && (t = I.SCRIPTSCRIPT),
      t
    );
  },
  Dt = (r, e) => {
    var t = ua(r.size, e.style),
      a = t.fracNum(),
      n = t.fracDen(),
      s;
    s = e.havingStyle(a);
    ...
    r.hasBarLine
      ? (r.barSize
          ? ((b = K(r.barSize, e)), (g = y.makeLineSpan("frac-line", e, b)))
          : (g = y.makeLineSpan("frac-line", e)),
        (b = g.height),
        (w = g.height))
      : ((g = null), (b = 0), (w = e.fontMetrics().defaultRuleThickness));
    var x, z, T;
    t.size === I.DISPLAY.size || r.size === "display"
    ...
    if (g) {
      ...
      (x - o.depth - (R + 0.5 * b) < z &&
        (x += z - (x - o.depth - (R + 0.5 * b))),
        R - 0.5 * b - (p.height - T) < z &&
          (T += z - (R - 0.5 * b - (p.height - T))));
      var F = -(R - 0.5 * b);
      D = y.makeVList(
        {
          positionType: "individualShift",
      ...
      var C = x - o.depth - (p.height - T);
      (C < z && ((x += 0.5 * (z - C)), (T += 0.5 * (z - C))),
        (D = y.makeVList(
          {
            positionType: "individualShift",
            children: [
    ...
    ((s = e.havingStyle(t)),
      (D.height *= s.sizeMultiplier / e.sizeMultiplier),
      (D.depth *= s.sizeMultiplier / e.sizeMultiplier));
    var G;
    t.size === I.DISPLAY.size
      ? (G = e.fontMetrics().delim1)
      : t.size === I.SCRIPTSCRIPT.size
        ? (G = e.havingStyle(I.SCRIPT).fontMetrics().delim2)
        : (G = e.fontMetrics().delim2);
    var H, U;
    return (
      r.leftDelim == null
        ? (H = ue(e, ["mopen"]))
        : (H = N0.customSizedDelim(
            r.leftDelim,
            G,
            !0,
            e.havingStyle(t),
...
B({
  ...
  handler(r, e) {
    var { parser: t } = r,
      ...
      n = e[5],
      s = qe(e[0]),
      o = s.type === "atom" && s.family === "open" ? sr(s.text) : null,
      h = qe(e[1]),
      m = h.type === "atom" && h.family === "close" ? sr(h.text) : null,
      p = L(e[2], "size"),
      g,
      b = null;
    ...
    } else ((x = L(x, "textord")), (w = ir[Number(x.text)]));
    return {
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
var ha = (r, e) => {
    ...
    r.type === "supsub"
      ...
      : (n = L(r, "horizBrace"));
    var s = P(n.base, e.havingBaseStyle(I.DISPLAY)),
      o = q0.svgSpan(n, e),
      h;
    if (
      (n.isOver
      ...
      var m = y.makeSpan(["mord", n.isOver ? "mover" : "munder"], [h], e);
      n.isOver
        ? (h = y.makeVList(
            {
              positionType: "firstBaseline",
...
B({
  ...
  mathmlBuilder: (r, e) => {
    var t = G0(r.body, e);
    return (
      t instanceof h0 || (t = new h0("mrow", [t])),
...
B({
  ...
  handler: (r, e) => {
    ...
    return t.settings.isTrusted(h)
      ? { type: "html", mode: t.mode, attributes: m, body: Q(o) }
...
B({
  ...
  handler: (r, e, t) => {
    ...
    if (t[0])
      for (
        var m = L(t[0], "raw").string, p = m.split(","), g = 0;
        g < p.length;
        g++
      ) {
        var b = p[g].split("=");
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t;
    r.alignment === "clap"
      ? ((t = y.makeSpan([], [P(r.body, e)])),
        (t = y.makeSpan(["inner"], [t], e)))
      : (t = y.makeSpan(["inner"], [P(r.body, e)]));
    ...
    return (
      ...
      (n = y.makeSpan(["thinbox"], [n], e)),
      y.makeSpan(["mord", "vbox"], [n], e)
    );
  },
  mathmlBuilder: (r, e) => {
    var t = new S.MathNode("mpadded", [$(r.body, e)]);
    if (r.alignment !== "rlap") {
...
var ma = (r, e, t, a, n, s, o) => {
      ...
      w = y.makeVList(
        {
          ...
          children: [
            ...
            { type: "elem", elem: m.elem, marginLeft: A(-s) },
    ...
    var D = [w];
    if (m && s !== 0 && !h) {
      var C = y.makeSpan(["mspace"], [], a);
      ((C.style.marginRight = A(s)), D.unshift(C));
    }
  ...
  ne = (r, e) => {
    ...
    var o = e.style,
      h = !1;
    o.size === I.DISPLAY.size &&
      s.symbol &&
      !q.contains(ca, s.name) &&
      (h = !0);
    var m;
    if (s.symbol) {
      ...
      if (
        ...
        (m = y.makeSymbol(s.name, p, "math", e, [
          "mop",
          "op-symbol",
          h ? "large-op" : "small-op",
        ])),
      ...
      x.length === 1 && x[0] instanceof p0
        ? ((m = x[0]), (m.classes[0] = "mop"))
        : (m = y.makeSpan(["mop"], x, e));
    } else {
      for (var z = [], T = 1; T < s.name.length; T++)
        z.push(y.mathsym(s.name[T], s.mode, e));
      m = y.makeSpan(["mop"], z, e);
    }
    var D = 0,
      C = 0;
    return (
      (m instanceof p0 || s.name === "\\oiint" || s.name === "\\oiiint") &&
        !s.suppressBaseShift &&
        ((D = (m.height - m.depth) / 2 - e.fontMetrics().axisHeight),
        (C = m.italic)),
      n
        ? ma(m, t, a, e, o, C, D)
        : (D && ((m.style.position = "relative"), (m.style.top = A(D))), m)
    );
  },
  ce = (r, e) => {
    var t;
...
var da = (r, e) => {
      ...
      for (
        var h = s.body.map((b) => {
            ...
            return typeof w == "string"
              ? { type: "textord", mode: b.mode, text: w }
              : b;
          }),
    ...
    return n ? ma(o, t, a, e, e.style, 0, 0) : o;
  },
  yn = (r, e) => {
    for (
    ...
    return r.parentIsSupSub
      ? new S.MathNode("mrow", [m, p])
      : S.newDocumentFragment([m, p]);
  };
B({
  type: "operatorname",
...
W0({
  ...
  htmlBuilder(r, e) {
    return r.semisimple
      ? y.makeFragment(t0(r.body, e, !1))
      : y.makeSpan(["mord"], t0(r.body, e, !0), e);
  },
  mathmlBuilder(r, e) {
...
B({
  ...
  mathmlBuilder(r, e) {
    ...
    t.setAttribute("stretchy", "true");
    var a = new S.MathNode("mover", [$(r.body, e), t]);
    return (a.setAttribute("accent", "true"), a);
  },
});
B({
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = y.makeSpan(["inner"], [P(r.body, e.withPhantom())]),
      a = y.makeSpan(["fix"], []);
...
B({
  ...
  handler: (r, e) => {
    ...
    return { type: "sizing", mode: n.mode, size: or.indexOf(a) + 1, body: s };
  },
  htmlBuilder: xn,
  mathmlBuilder: (r, e) => {
    var t = e.havingSize(r.size),
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var o = n + s / 4,
      ...
      { span: m, ruleWidth: p, advanceWidth: g } = N0.sqrtImage(h, e),
      b = m.height - p;
    ...
    if (r.index) {
      var z = e.havingStyle(I.SCRIPTSCRIPT),
        T = P(r.index, z, e),
        D = 0.6 * (x.height - x.depth),
        C = y.makeVList(
          {
            positionType: "shift",
            positionData: -D,
        ...
        R = y.makeSpan(["root"], [C]);
      return y.makeSpan(["mord", "sqrt"], [R, x], e);
    } else return y.makeSpan(["mord", "sqrt"], [x], e);
  },
  mathmlBuilder(r, e) {
    var { body: t, index: a } = r;
    return a
      ? new S.MathNode("mroot", [$(t, e), $(a, e)])
      : new S.MathNode("msqrt", [$(t, e)]);
  },
});
var ur = {
  display: I.DISPLAY,
...
var wn = function (e, t) {
  ...
  if (a)
    if (a.type === "op") {
      var n =
        a.limits && (t.style.size === I.DISPLAY.size || a.alwaysHandleSupSub);
      return n ? ne : null;
    } else if (a.type === "operatorname") {
      var s =
        a.alwaysHandleSupSub && (t.style.size === I.DISPLAY.size || a.limits);
      return s ? da : null;
    } else {
      if (a.type === "accent") return q.isCharacterBox(a.base) ? Mt : null;
      if (a.type === "horizBrace") {
        var o = !e.sub;
        return o === a.isOver ? ha : null;
      } else return null;
    }
  else return null;
};
W0({
  ...
  htmlBuilder(r, e) {
    ...
    if (m) {
      ...
      (o instanceof p0 || F) && (R = A(-o.italic));
    }
    var G;
    if (h && m) {
      ((g = Math.max(g, T, h.depth + 0.25 * p.xHeight)),
        (b = Math.max(b, p.sub2)));
      var H = p.defaultRuleThickness,
        U = 4 * H;
      if (g - h.depth - (m.height - b) < U) {
        b = U - (g - h.depth) + m.height;
        var V = 0.8 * p.xHeight - (g - h.depth);
        V > 0 && ((g += V), (b -= V));
      }
      var j = [
        { type: "elem", elem: m, shift: b, marginRight: C, marginLeft: R },
        { type: "elem", elem: h, shift: -g, marginRight: C },
      ];
      G = y.makeVList({ positionType: "individualShift", children: j }, e);
    } else if (m) {
      b = Math.max(b, p.sub1, m.height - 0.8 * p.xHeight);
      var Y = [{ type: "elem", elem: m, marginLeft: R, marginRight: C }];
      G = y.makeVList(
        { positionType: "shift", positionData: b, children: Y },
        e,
      );
    } else if (h)
      ((g = Math.max(g, T, h.depth + 0.25 * p.xHeight)),
        (G = y.makeVList(
          {
            positionType: "shift",
            positionData: -g,
            children: [{ type: "elem", elem: h, marginRight: C }],
          },
          e,
        )));
    else throw new Error("supsub must have either sup or sub.");
    var z0 = ht(o, "right") || "mord";
    return y.makeSpan([z0], [o, y.makeSpan(["msupsub"], [G])], e);
  },
  mathmlBuilder(r, e) {
    var t = !1,
      a,
    ...
    if (t) o = a ? "mover" : "munder";
      ...
      if (r.sup) {
        var p = r.base;
        (p && p.type === "op" && p.limits && e.style === I.DISPLAY) ||
        (p &&
          p.type === "operatorname" &&
          p.alwaysHandleSupSub &&
          (e.style === I.DISPLAY || p.limits))
          ? (o = "munderover")
          : (o = "msubsup");
      } else {
        var m = r.base;
        (m &&
          m.type === "op" &&
          m.limits &&
          (e.style === I.DISPLAY || m.alwaysHandleSupSub)) ||
        (m &&
          m.type === "operatorname" &&
          m.alwaysHandleSupSub &&
          (m.limits || e.style === I.DISPLAY))
          ? (o = "munder")
          : (o = "msub");
      }
    else {
      ...
      (h &&
        h.type === "op" &&
        h.limits &&
        (e.style === I.DISPLAY || h.alwaysHandleSupSub)) ||
      (h &&
        h.type === "operatorname" &&
        h.alwaysHandleSupSub &&
        (h.limits || e.style === I.DISPLAY))
        ? (o = "mover")
        : (o = "msup");
    }
...
var pa = { mi: "italic", mn: "normal", mtext: "normal" };
W0({
  type: "mathord",
  htmlBuilder(r, e) {
  ...
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mi", [v0(r.text, r.mode, e)]),
      a = kt(r, e) || "italic";
    return (a !== pa[t.type] && t.setAttribute("mathvariant", a), t);
  },
});
W0({
  type: "textord",
  ...
  mathmlBuilder(r, e) {
    ...
    return (
      ...
      a !== pa[n.type] && n.setAttribute("mathvariant", a),
      n
    );
  },
});
...
W0({
  ...
  htmlBuilder(r, e) {
    if (at.hasOwnProperty(r.text)) {
      ...
      if (rt.hasOwnProperty(r.text))
        return y.makeSpan(["mspace", rt[r.text]], [], e);
  ...
  mathmlBuilder(r, e) {
    ...
    if (at.hasOwnProperty(r.text))
      ...
      if (rt.hasOwnProperty(r.text)) return new S.MathNode("mspace");
      throw new M('Unknown type of space "' + r.text + '"');
    }
    return t;
  },
...
var mr = {
  ...
  cr = { "\\textbf": "textbf", "\\textmd": "textmd" },
  kn = { "\\textit": "textit", "\\textup": "textup" },
  dr = (r, e) => {
    var t = r.font;
    if (t) {
      if (mr[t]) return e.withTextFontFamily(mr[t]);
    ...
    return e.withTextFontShape(kn[t]);
  };
B({
  type: "text",
  names: [
...
B({
  ...
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mo", [new S.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var a = new S.MathNode("munder", [$(r.body, e), t]);
    return (a.setAttribute("accentunder", "true"), a);
  },
});
B({
  ...
  mathmlBuilder(r, e) {
    return new S.MathNode("mpadded", [$(r.body, e)], ["vcenter"]);
  },
});
B({
  type: "verb",
  ...
  htmlBuilder(r, e) {
    for (
      var t = fr(r), a = [], n = e.havingStyle(e.style.text()), s = 0;
      s < t.length;
      s++
    ) {
      var o = t[s];
      (o === "~" && (o = "\\textasciitilde"),
        a.push(
          y.makeSymbol(o, "Typewriter-Regular", r.mode, n, ["mord", "texttt"]),
        ));
    }
    return y.makeSpan(
...
var qt = (r, e, t, a) => {
  ...
  return ((o && a) || r.macros.set(s, { tokens: n, numArgs: h }), "");
};
c("\\newcommand", (r) => qt(r, !1, !0, !1));
c("\\renewcommand", (r) => qt(r, !0, !1, !1));
c("\\providecommand", (r) => qt(r, !0, !0, !0));
c("\\message", (r) => {
...
var ga = A(x0["Main-Regular"][84][1] - 0.7 * x0["Main-Regular"][65][1]);
c(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" +
    ("L\\kern-.36em\\raisebox{" + ga + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{LaTeX}}",
);
c(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" +
    ("K\\kern-.17em\\raisebox{" + ga + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{KaTeX}}",
);
...
class Cn {
  constructor(e, t, a) {
    ((this.settings = void 0),
      ...
      this.feed(e),
      (this.macros = new Nn(Dn, t.macros)),
      (this.mode = a),
      (this.stack = []));
  }
  feed(e) {
  ...
  scanArgument(e) {
    ...
    return (
      this.pushToken(new f0("EOF", a.loc)),
      this.pushTokens(n),
      t.range(a, "")
    );
  }
  ...
  expandOnce(e) {
    ...
    if (n.numArgs) {
      ...
      for (var h = s.length - 1; h >= 0; --h) {
        ...
        if (m.text === "#") {
          if (h === 0)
            throw new M("Incomplete placeholder at end of macro body", m);
          if (((m = s[--h]), m.text === "#")) s.splice(h + 1, 1);
          else if (/^[1-9]$/.test(m.text)) s.splice(h, 2, ...o[+m.text - 1]);
    ...
    if (typeof n == "string") {
      ...
      if (n.indexOf("#") !== -1)
        for (var o = n.replace(/##/g, ""); o.indexOf("#" + (s + 1)) !== -1; )
          ++s;
      for (
        var h = new pr(n, this.settings), m = [], p = h.lex();
        p.text !== "EOF";
      )
        (m.push(p), (p = h.lex()));
      m.reverse();
      var g = { tokens: m, numArgs: s };
      return g;
    }
    return n;
  }
...
class He {
  constructor(e, t) {
    ((this.mode = void 0),
      ...
      (this.mode = "math"),
      (this.gullet = new Cn(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    ...
    return (
      this.mode === "text" && this.formLigatures(a),
    ...
    for (var a, n; ; ) {
      ...
      if (s.text === "\\limits" || s.text === "\\nolimits") {
        ...
        for (g.push(new f0(ze[s.text])), this.consume(); ; ) {
          ...
          if (!ze[b] || br.test(b) !== p) break;
          (g.unshift(new f0(ze[b])), this.consume());
        }
  ...
  parseSizeGroup(e) {
    ...
    if (!Nr(s)) throw new M("Invalid unit: '" + s.unit + "'", t);
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      s == null && n[0] === "\\" && !ya.hasOwnProperty(n))
    ) {
  ...
  parseSymbol() {
    ...
    if (/^\\verb[^a-zA-Z]/.test(t)) {
      ...
      return (
        (a = a.slice(1, -1)),
        { type: "verb", mode: "text", body: a, star: n }
      );
    }
    ...
    if (X[this.mode][t]) {
      ...
      var h = X[this.mode][t].group,
        m = u0.range(e),
        p;
      if (b1.hasOwnProperty(h)) {
        var g = h;
        p = { type: "atom", mode: this.mode, family: g, loc: m, text: t };
    ...
    if ((this.consume(), s))
      for (var b = 0; b < s[0].length; b++) {
        var w = s[0][b];
        if (!nt[w]) throw new M("Unknown accent ' " + w + "'", e);
...
var qn = function (e, t) {
  ...
  wa = function (e, t, a) {
    ...
    var n = y.makeSpan(["katex-error"], [new p0(t)]);
    return (
...
function Fn(r, e) {
  return ka(r, {}) || { type: "root", children: [] };
}
function ka(r, e) {
  const t = Ln(r, e);
...
function wr(r, e) {
  return { type: "root", children: Sa(r, e) };
}
function Hn() {
  return { type: "doctype" };
}
...
function Gn(r, e) {
  const t = r.namespaceURI,
    a = t === it.svg ? Ca : qa,
    n = t === it.html ? r.tagName.toLowerCase() : r.tagName,
    s = t === it.html && n === "template" ? r.content : r,
    o = r.getAttributeNames(),
    h = {};
  let m = -1;
  for (; ++m < o.length; ) h[o[m]] = r.getAttribute(o[m]) || "";
  return a(n, h, Sa(s, e));
}
function Sa(r, e) {
...
const kr = function (r, e, t) {
    ...
    for (; ++e < r.children.length; )
      if (a(r.children[e], e, r)) return r.children[e];
  },
  j0 = function (r) {
    if (r == null) return Wn;
    if (typeof r == "string") return Xn(r);
    if (typeof r == "object") return $n(r);
    if (typeof r == "function") return Ot(r);
    throw new Error("Expected function, string, or array as `test`");
  };
function $n(r) {
  const e = [];
  let t = -1;
  for (; ++t < r.length; ) e[t] = j0(r[t]);
  return Ot(a);
  function a(...n) {
    let s = -1;
    for (; ++s < e.length; ) if (e[s].apply(this, n)) return !0;
    return !1;
  }
}
function Xn(r) {
...
function Ot(r) {
  ...
  function e(t, a, n) {
    return !!(
      jn(t) && r.call(this, t, typeof a == "number" ? a : void 0, n || void 0)
    );
  }
}
function Wn(r) {
...
function Jn(r, e) {
  const t = e || {},
    ...
    n = Ma(r),
    s = Ta(r, { whitespace: t.whitespace || "normal" }),
    o = [];
  (r.type === "text" || r.type === "comment") &&
    o.push(...Aa(r, { breakBefore: !0, breakAfter: !0 }));
  let h = -1;
  for (; ++h < a.length; )
    o.push(
      ...za(a[h], r, {
        whitespace: s,
        breakBefore: h ? void 0 : n,
        breakAfter: h < a.length - 1 ? pt(a[h + 1]) : n,
      }),
    );
  const m = [];
  let p;
...
`)
    ...
    o = o.concat(
      za(n[s], r, {
        whitespace: a,
        breakBefore: s ? void 0 : h,
        breakAfter: s < n.length - 1 ? pt(n[s + 1]) : m,
      }),
    );
  return (
    zr(r) && kr(e, r, zr) && o.push("	"),
    h && o.unshift(h),
    m && o.push(m),
    o
  );
...
function Aa(r, e) {
  ...
  for (; s <= t.length; ) {
    Sr.lastIndex = s;
    const m = Sr.exec(t),
      p = m && "index" in m ? m.index : t.length;
    (a.push(
      e4(
        t
          .slice(s, p)
  ...
  let o = -1,
    h;
  for (; ++o < a.length; )
    a[o].charCodeAt(a[o].length - 1) === 8203 ||
    (o < a.length - 1 && a[o + 1].charCodeAt(0) === 8203)
      ? (n.push(a[o]), (h = void 0))
      : a[o]
        ? (typeof h == "number" && n.push(h), n.push(a[o]), (h = 0))
        : (o === 0 || o === a.length - 1) && n.push(0);
  return n;
}
function _n(r) {
...
function e4(r, e, t) {
  ...
  for (; n < r.length; ) {
    Mr.lastIndex = n;
    const o = Mr.exec(r);
    ((s = o ? o.index : r.length),
      !n && !s && o && !e && a.push(""),
      n !== s && a.push(r.slice(n, s)),
      (n = o ? s + o[0].length : s));
  }
  return (n !== s && !t && a.push(""), a.join(" "));
}
function Ta(r, e) {
  if (r.type === "element") {
...
function l4(r) {
  const e = r || n4;
  return function (t, a) {
    Ia(t, "element", function (n, s) {
      const o = Array.isArray(n.properties.className)
          ? n.properties.className
          : i4,
        h = o.includes("language-math"),
        m = o.includes("math-display"),
      ...
      if (
        (n.tagName === "code" &&
          ...
          b.type === "element" &&
          b.tagName === "pre" &&
          ((w = b), (b = s[s.length - 2]), (g = !0)),
        !b)
      )
        return;
      const x = Jn(w, { whitespace: "pre" });
      let z;
      try {
        z = xr.renderToString(x, { ...e, displayMode: g, throwOnError: !0 });
      } catch (D) {
        const C = D,
      ...
      typeof z == "string" && (z = Un(z).children);
      const T = b.children.indexOf(w);
      return (b.children.splice(T, 1, ...z), Ra);
    });
  };
}
